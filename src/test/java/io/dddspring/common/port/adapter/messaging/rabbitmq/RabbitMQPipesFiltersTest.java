...
import io.dddspring.common.notification.NotificationReader;
import io.dddspring.common.notification.NotificationSerializer;
import io.dddspring.common.port.adapter.messaging.AllPhoneNumbersCounted;
import io.dddspring.common.port.adapter.messaging.AllPhoneNumbersListed;
import io.dddspring.common.port.adapter.messaging.MatchedPhoneNumbersCounted;
import io.dddspring.common.port.adapter.messaging.PhoneNumbersMatched;
...
//        super.tearDown();
    ...
    private class PhoneNumberExecutive extends ExchangeListener {
        ...
        protected void filteredDispatch(String aType, String aTextMessage) {
            ...
            if (reader.typeName().contains("AllPhoneNumbersCounted")) {
                ...
                System.out.println("AllPhoneNumbersCounted..."+process.totalPhoneNumbers());
                ...
                System.out.println("MatchedPhoneNumbersCounted..."+process.matchedPhoneNumbers());
            }
        ...
        protected String[] listensTo() {
            return new String[] {
                    "com.weailove.common.port.adapter.messaging.AllPhoneNumbersCounted",
                    "com.weailove.common.port.adapter.messaging.MatchedPhoneNumbersCounted",
            };
        }
    }
    ...
    private class PhoneNumberFinder extends ExchangeListener {
        ...
        @Override
        protected String[] listensTo() {
            return new String[] { "com.weailove.common.port.adapter.messaging.AllPhoneNumbersListed" };
        }
    }
    ...
    private class MatchtedPhoneNumberCounter extends ExchangeListener {
        ...
        @Override
        protected String[] listensTo() {
            return new String[] { "com.weailove.common.port.adapter.messaging.PhoneNumbersMatched" };
        }
    }
